...
if __name__ == "__main__":
    print("=" * 80)
    print("Benchmark Comparison Tests")
    print("=" * 80)
    
    try:
        test_american_to_prob()
        test_nfelo_prob()
        test_spread_baseline()
        test_home_favorite_baseline()
        test_mcnemar()
        test_delong()
        test_paired_t()
        ...
        print("=" * 80)
        print("\nThe benchmark comparison system is ready to use.")
        print("\nTo use the system:")
        print("  # Compare single season")
        print("  python -m analysis.benchmark_comparison --season 2025 --generate-report")
        print("")
        print("  # Compare multiple seasons")
        print("  python -m analysis.benchmark_comparison --start-season 2023 --end-season 2025 --generate-report")
        print("")
        print("Note: Requires matchup_features.parquet with predictions and benchmark data")
