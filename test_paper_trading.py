...
if __name__ == "__main__":
    print("=" * 80)
    print("Paper Trading Simulator Tests")
    print("=" * 80)
    ...
    try:
        ...
        print("\nTo use the system:")
        print("  # Simulate single strategy")
        print("  python -m analysis.paper_trading --season 2025 --strategy moderate")
        print("")
        print("  # Compare all strategies")
        print("  python -m analysis.paper_trading --season 2025 --compare-strategies")
        print("")
        print("  # Generate full report")
        print("  python -m analysis.paper_trading --season 2025 --generate-report")
        print("")
        print("Note: Requires CLV data from clv_tracker.")
